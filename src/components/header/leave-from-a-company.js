...
export default function LeaveFromACompanyModal({ ...props }) {
    ...
    return (
        <>
            <Modal.Header closeButton onClick={() => props.setShowLeaveFromACompanyModal(false)}>
            ...
            <Modal.Footer>
                <Button variant="danger" onClick={() => props.setShowLeaveFromACompanyModal(false)}>
                    Fechar
                </Button>
